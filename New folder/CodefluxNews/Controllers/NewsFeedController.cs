...
namespace CodefluxNews.Controllers
{
    public class NewsFeedController : Controller
    {
        ...
        public ActionResult Index(NewsFeed feed)
        {
            ...
            return View(db.NewsFeeds.Where(x=>x.Active==true).ToList());
        }
        ...
        [HttpPost]
        [Authorize]
        public ActionResult Edit([Bind(Include = "NewsFeedId,ProviderId, RssUrl,CategoryId")] int id, NewsFeed feed, HttpPostedFileBase Picture)
        {
            try
            {
                //Extract Image File Name.
